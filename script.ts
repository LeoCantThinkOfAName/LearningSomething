let luv: boolean                 = true;
let firstName: string            = 'Candy';
let lastName: string             = 'Cheng';
let met: number                  = 2014;
let favFood: string[]            = ['cramel', 'chocolate', 'sweets'];

let sentence: string             = `I met ${firstName} in ${met}. She is ${luv}ly a wonderful girl. Her favorite foods are ${favFood[0]} ${favFood[1]} and ${favFood[2]}.`

enum ipAddr {NTU = 112, NCTU    = 113, NCHU = 114, NCKU = 116};
let colleage: [string, ipAddr]   = [ipAddr[116], ipAddr.NCKU];

let somethig: any                = false;
let unuseable: void              = null;

let someValue: any               = 'something happend';
...
// let myObj = {label: 'something', kappa: 123};
// printLabel(myObj);
